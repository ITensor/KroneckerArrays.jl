---
name: KroneckerArrays.jl bug report
about: Create a bug report to help us improve KroneckerArrays.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("KroneckerArrays")`:
```julia
julia> using Pkg; Pkg.status("KroneckerArrays")
[YOUR OUTPUT HERE]
```
